...
int main(){
    ...
    list.SortedInsert(8);
    list.SortedInsert(6);
	cout <<"The list with the values inserted is: ";
	list.print();
    cout <<"Number of times shown: " << searchFor << ": ";
    list.Count(searchFor);
	list.RemoveDuplicates();
	cout <<"The list without duplicate numbers is: ";
	list.print();
	list.Reverse();
	cout <<"The list with reversed numbers is: ";
	list.print();
	list.duplicar();
	cout<<"The list with duplicate numbers is: ";
	list.print();
    list.DeleteList();
    list.print();
}
